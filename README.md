...
While existing [tools](https://rusa.bike/) are excellent for searching out permament RUSA routes *for riding*, I wanted to examine the riding *history* of the club. RandoVisual thus makes no effort to render or display all possible routes and will likely never build a listing of routes or search-oriented tools. Instead it tries to answer the question: "what have we collectively done?".
